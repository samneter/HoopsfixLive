...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { club: @membership.club, competition: @membership.competition } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { club: @membership.club, competition: @membership.competition } }
